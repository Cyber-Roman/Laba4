...
namespace lab1.Controllers
{
    ...
    public class LibraryController : Controller
    {
        ...
        {
            return Content("Я Приветствую вас в своей онлайн библиотеке!");
        }
        ...
        public IActionResult ListBooks()
        {
            ...
            return Content("<h2>Список книг</h2>" + "<table>" + "<tr><th>Название книги</th><th>Автор</th></tr>" + string.Join("", books.Select(book =>
                    $"<tr><td>{book.Title}</td><td>{book.Author}</td></tr>")) + "</table>", "text/html; charset=utf-8"
            );
        }
        [HttpGet("Profile/{id?}")]
        public IActionResult Profile(int? id)
        {
            ...
            {
                return Content("Нет информации о пользователе", "text/html; charset=utf-8");
            }
        }
